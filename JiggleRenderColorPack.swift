...
struct JiggleRenderColorPack {
    
    let strokeRed: Float
    let strokeGreen: Float
    let strokeBlue: Float
    
    let fillUnselectedRed: Float
    let fillUnselectedGreen: Float
    let fillUnselectedBlue: Float
    
    let fillSelectedRed: Float
    let fillSelectedGreen: Float
    let fillSelectedBlue: Float
    
    let fillModifiedRed: Float
    let fillModifiedGreen: Float
    let fillModifiedBlue: Float
    
    let fillJiggleCenterRed: Float
    let fillJiggleCenterGreen: Float
    let fillJiggleCenterBlue: Float
